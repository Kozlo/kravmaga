...
module.exports = {
    ...
    updateOne(req, res, next) {
        ...
        Location.findByIdAndUpdate(entryId, entryProps, opts)
    ...
    deleteOne(req, res, next) {
        ...
        Location.findByIdAndRemove(entryId)
