...
module.exports = {
    ...
    updateOne(req, res, next) {
        ...
        PaymentType.findByIdAndUpdate(entryId, entryProps, opts)
    ...
    deleteOne(req, res, next) {
        ...
        PaymentType.findByIdAndRemove(entryId)
